...
const mockTestimonials = [
  {
    ...
    testimonial: 'Working with Joe was an absolute pleasure. The attention to detail and creative solutions exceeded our expectations. Our new website has significantly improved our online presence.',
  ...
  },
  {
    ...
    testimonial: 'Joe delivered exceptional results on our project. The technical expertise and design sense really made our application stand out. Highly recommended!',
    clientImage: '/api/placeholder/100/100',
    rating: 5,
  },
  {
    ...
    testimonial: 'The website Joe built for us is not only beautiful but also incredibly fast and user-friendly. Our conversion rates have increased by 40% since the launch.',
    clientImage: '/api/placeholder/100/100',
    rating: 5,
  },
]
